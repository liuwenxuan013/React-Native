...
class IOSUploader extends _BaseUploader().default {
  ...
  async _getAppleIdCredentials() {
    ...
    const result = {
      appleId: _getenv().default.string('EXPO_APPLE_ID', this.options.appleId),
      appleIdPassword: _getenv().default.string('EXPO_APPLE_ID_PASSWORD', this.options.appleIdPassword)
    };
    const {
      appleId,
      appleIdPassword
