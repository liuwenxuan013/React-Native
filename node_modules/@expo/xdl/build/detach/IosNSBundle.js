...
async function _configureInfoPlistAsync(context) {
  ...
  let result = await IosPlist().modifyAsync(supportingDirectory, 'Info', infoPlist => {
    ...
    infoPlist.FacebookAdvertiserIDCollectionEnabled = config.facebookAdvertiserIDCollectionEnabled || false; // set ITSAppUsesNonExemptEncryption to let people skip manually
