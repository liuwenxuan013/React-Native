...
function withReporting(config, env) {
    ...
    const { absolute, root } = env.locations || env_1.getPaths(env.projectRoot);
    ...
    // @ts-ignore
    new webpack_bundle_analyzer_1.BundleAnalyzerPlugin(Object.assign(Object.assign({}, reportConfig), { logLevel: reportConfig.verbose ? 'info' : 'silent', statsFilename: absolute(reportDir, reportConfig.statsFilename), reportFilename: absolute(reportDir, reportConfig.reportFilename) })));
    return config;
}
